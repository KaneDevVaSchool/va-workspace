...
import { MAX_COMMENT_ATTACHMENTS } from '../constants/comments.js';
import CommentEditor from './CommentEditor.vue';
import CommentEmojiPicker from './CommentEmojiPicker.vue';
import CommentUploadCards from './CommentUploadCards.vue';

// Rút gọn từ Modules/Social/resources/js/components/SocialCommentComposer.vue:
// bỏ hẳn sticker (insertSticker, panel emoji/sticker) — chỉ còn emoji. Nhận
// `endpoint` + `mentions-endpoint` từ ngoài (thay vì hard-code postId) vì
// Task và Project dùng 2 đường dẫn API khác nhau.
const props = defineProps({
  ...
  prompt: { type: String, default: 'Bạn có muốn thảo luận?' },
        ...
        <div class="comment-composer__actions-left">
          <div ref="pickerWrap" class="comment-composer__emoji-wrap">
            <button
              ...
              :class="{ 'comment-composer__tool--on': pickerOpen }"
