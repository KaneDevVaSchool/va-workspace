...
class UpdateSprintRequest extends FormRequest
{
    ...
    {
        // Route chỉ có {sprint} (int) — lấy project_id qua chính sprint để
        // ràng buộc phase_id đúng dự án (không cho gán giai đoạn dự án khác).
        $projectId = Sprint::query()->find($this->route('sprint'))?->project_id;
