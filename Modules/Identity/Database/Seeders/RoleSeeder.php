...
/**
 * 7 role hệ thống — xem docs/VA_WORKSPACE_OVERVIEW.md §4.1. Dữ liệu hệ
 * thống (không phải demo) nên chạy ở MỌI environment, khác với
 * DemoUserSeeder/DepartmentSeeder chỉ chạy ở local/testing.
 */
