  ...
  <div class="login">
    ...
    <div class="login__container">
      ...
      <div class="login__card">
        ...
        <p class="login__subtitle">Đăng nhập thông qua tài khoản mail do nhà trường cung cấp</p>
        ...
        <div class="login__actions">
          ...
          >
            <img src="/images/google.png" alt="" class="login__google-icon" />
          </button>
        </div>

        <div v-if="fallbackEnabled" class="login__fallback">
          <a href="/auth/fallback" class="login__fallback-link">Google gặp sự cố? Đăng nhập khẩn cấp</a>
        </div>
      </div>
    </div>
  </div>
