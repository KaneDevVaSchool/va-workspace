...
/**
 * Xoá override theo composite identity (role_code, permission_key,
 * scope_type, scope_id) — cùng bộ cột với unique index `perm_grants_unique`.
 */
class DestroyPermissionGrantRequest extends FormRequest
{
