...
const workData = {
    title: "Công việc",
    description:
        "Giao việc, theo dõi tiến độ, chấm điểm và xem kết quả tổng hợp — tất cả trong một luồng liên tục.",
    canvasW: 1750,
    canvasH: 920,
    nodes: [
        {
...
const projectData = {
    title: "Dự án",
    description:
        "Tạo dự án, phân công việc theo sơ đồ cây, theo dõi lịch biểu và xem kết quả — giao việc được cho cả phòng khác.",
    canvasW: 1750,
    canvasH: 920,
    nodes: [
        {
...

        {
            ...
            w: 400,
            icon: "layers",
            title: "Sơ đồ & Lịch biểu",
            teaser: "Trưởng nhóm · Thành viên",
            items: [
            ...
            children: [
                {
                    ...
                    icon: "dollarSign",
                    title: "Chi phí dự án",
                    teaser: "Tài chính & dòng tiền",
                },
                {
                    id: "n12",
                    icon: "fileDown",
                    title: "Tài liệu đính kèm",
                    teaser: "File, biểu mẫu",
                },
                {
                    id: "n13",
                    icon: "layers",
                    title: "Vật tư cần dùng",
                    teaser: "Dự toán theo phòng ban",
                },
            ],
        },
    ],
...
const workspaceData = {
    ...
    description:
        "Thiết lập toàn bộ hệ thống — thêm người, phân quyền, bật/tắt tính năng từng phòng ban — không cần biết kỹ thuật.",
    canvasW: 1750,
    canvasH: 920,
    nodes: [
        {
...

        {
            ...
            icon: "layoutList",
            title: "Menu & Màn hình",
            teaser: "Quản trị viên · Trưởng phòng",
            items: [
            ...
            button: {
                label: "Cài đặt menu",
                to: { name: "manager.workspace-config.sidebar" },
            },
        },
...

        {
            ...
            w: 400,
            icon: "settings",
            title: "Tuỳ chỉnh theo phòng ban",
            teaser: "Trưởng phòng",
            items: [
            ...
            children: [
                {
                    ...
                    teaser: "Ai được làm gì",
                },
                {
                    id: "n12",
                    icon: "star",
                    title: "Cài chấm điểm task",
                    teaser: "Điểm tự động khi xong",
                },
                {
                    id: "n13",
                    icon: "barChart",
                    title: "KPI theo phòng ban",
